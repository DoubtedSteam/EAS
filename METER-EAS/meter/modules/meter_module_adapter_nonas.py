...
class METERTransformerSS(pl.LightningModule):
    def __init__(self, 
        ...
        extra_param = sum(p.numel() for n, p in self.named_parameters() if "adapter" in n and "self_attn" not in n and "cross_attn" not in n)
        ...
        self.clean_flag()
        self.apply_flag(torch.LongTensor([13,  8, 17,  4,  6, 12, 23,  2,  1,  0]))

        # NLVR:
        # 16 [23,  6, 21, 19,  5, 13,  7,  0, 12, 17, 22,  4,  2, 18,  3,  1]
        # 14 [22, 16, 11,  7, 23,  2,  4, 18,  1, 13, 19, 12,  3,  5]
        # 12 [23,  6, 19,  3,  8, 13,  2,  7, 21, 11, 15,  0]
        # 10 [15,  0, 23,  3, 10,  1, 13, 12, 18,  8]
        # 8 [19,  0, 12, 18, 15, 21,  9,  8]
        
        # VQA:
        # [16, 13,  6, 12, 18,  5,  3, 21, 15,  7]
        # [ 8, 12,  2,  5, 19, 13,  6,  7]

        # F30k
        # [12,  5, 20, 11, 18, 14,  3, 19, 13,  6]
        # [5, 12, 13, 18, 19, 20,  2, 14]
