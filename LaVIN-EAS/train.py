...
from eas.mm_adaptation import LaVIN
...
def get_args_parser():
    ...
    parser.add_argument('--adapter_type', type=str, default='attn', metavar='LENGTH',choices=['mlp', 'attn'],
    ...
    #search
    parser.add_argument('--nas_epoch', type=int, default=10)
    parser.add_argument('--skipped_num', type=int, default=0)
...
def main(args):
    ...
    if args.do_pretrain:
        ...
        dataset_val = ScienceQADataSet(args, 'val', args.llama_model_path, args.max_seq_len)
    ...
    # adapter_checkpoint = torch.load('./output/checkpoint-19.pth', map_location="cpu")
    # state_dict={}
